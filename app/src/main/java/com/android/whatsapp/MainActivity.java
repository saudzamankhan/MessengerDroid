...
import com.android.whatsapp.myclasses.StaticConfig;
import com.android.whatsapp.myclasses.ServiceUtils;
import com.android.whatsapp.myclasses.FriendsFragment;
import com.android.whatsapp.myclasses.GroupFragment;
import com.android.whatsapp.myclasses.LoginActivity;
import com.android.whatsapp.myclasses.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "WHATSAPP VERSION 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
